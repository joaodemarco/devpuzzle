...
ALTER TABLE "tech_type" ADD CONSTRAINT "tech_type_type_id_tech_types_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."tech_types"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "guess_the_tech_results" ADD CONSTRAINT "guess_the_tech_results_game_id_guess_the_tech_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."guess_the_tech_games"("id") ON DELETE no action ON UPDATE no action;